...
export const GAME_SESSION_STATE_CONFIG: {
  ...
  toastTranslationKeys: {
    ...
    resetGameSessionPhaseSuccess: '_GameSessionsPage.Game Session has been reset',
    nextGameSessionPhaseSuccess: '_GameSessionsPage.Game Session has been advanced',
    previousGameSessionPhaseSuccess: '_GameSessionsPage.Game Session has been retreated',
  },
};
