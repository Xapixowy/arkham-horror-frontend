export enum CardAttributeAbility {
  // Abilities
  ...
  ADD_PLUS_ONE_TO_SNEAK_DICE_RESULT = 'add_plus_one_to_sneak_dice_result',
  ADD_PLUS_ONE_TO_PROWESS_DICE_RESULT = 'add_plus_one_to_prowess_dice_result',
  ...
  BONUS_SNEAK_DICE_WHEN_SPENDING_CLUE = 'bonus_sneak_dice_when_spending_clue',
  BONUS_PROWESS_DICE_WHEN_SPENDING_CLUE = 'bonus_prowess_dice_when_spending_clue',

  // Success Modifiers
  SUCCESS_ON_4_5_6 = 'success_on_4_5_6',
  SUCCESS_ON_6_ONLY = 'success_on_6_only',

  // Maintenance
  GET_2_DOLLARS_ON_MAINTENANCE = 'get_2_dollars_on_maintenance',
